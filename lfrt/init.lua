...
\\9\\9f:close()\\\
  ...
  \\9assert(type(to) == 'string', 'invalid argument #2; expected string got ' .. type(to))\\\
  \\9assert(fs.exists(from), 'file not found; ' .. from)\\\
  \\9local tb = {}\\\
...
\\9\\9local obj = {}\\\
\\9\\9obj.title = (obj0.title or \\\"Blank LuaFoxUI Window\\\")\\\
\\9\\9obj.default_width=(obj0.width or 400)\\\
\\9\\9obj.default_height=(obj0.height or 200)\\\
\\9\\9obj.on_destroy = Gtk.main_quit\\\
\\9\\9local win = obj0\\\
...
\\9\\9\\9margin = 15\\\
\\9\\9})\\\
\\9\\9win._window:add(win._obj)\\\
\\9\\9function win:show()\\\
\\9\\9\\9self._window:show_all()\\\
\\9\\9end\\\
\\9\\9function win:appendChild(v)\\\
\\9\\9\\9self._obj:add(v._obj)\\\
\\9\\9end\\\
...
\\9\\9\\9obj[v.rKey] = self[k]\\\
\\9\\9end \\\
\\9\\9obj.halign = Gtk.Align[(self.align[1] or \\\"START\\\")]\\\
\\9\\9obj.valign = Gtk.Align[(self.align[2] or \\\"START\\\")]\\\
\\9\\9obj.hexpand = self.expand[1]\\\
\\9\\9obj.vexpand = self.expand[2]\\\
\\9\\9for k, v in pairs(obj) do\\\
\\9\\9\\9if k:sub(1, 3) == \\\"on_\\\" then\\\
\\9\\9\\9\\9self._obj[k] = v\\\
\\9\\9\\9else\\\
\\9\\9\\9\\9self._obj[\\\"set_\\\" .. k](self._obj, v)\\\
\\9\\9\\9end\\\
\\9\\9end\\\
\\9end\\\
...
\\9constructor=function(cls, clst, obj0)\\\
\\9\\9return whandle(Gtk.Label, {label = {rKey='label'}}, obj0)\\\
\\9end\\\
}))\\\
